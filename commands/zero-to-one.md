...
After A26 completes, scan output for escalation signals (see performance.md Model Routing). If A26 contains hedging language or found CRITICAL issues, escalate A27 from Haiku 4.5 to Sonnet 4.6.
...
Model escalation applies — check A26 and A27 output for escalation triggers before selecting model tier.
